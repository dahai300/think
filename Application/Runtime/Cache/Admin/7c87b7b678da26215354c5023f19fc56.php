...
<head>
	...
	<script type="text/javascript">
		...
		var addmoreUrl="<?php echo U(MODULE_NAME.'/Recruit/addMoreHandle');?>";
		var addsaveUrl="<?php echo U(MODULE_NAME.'/Recruit/addSaveHandle');?>";

		function addAndMore(){
			recruitForm.action=addmoreUrl;
		}
		function addAndSave(){
			recruitForm.action=addsaveUrl;
		}
	</script>
...
<body>
<form action="" method="post" id="recruitForm" name="recruitForm">
		<table class="table table-bordered table-hover definewidth m10">
			<thead>
				<tr>
					<th colspan="2">职位添加</th>
				</tr>
			</thead>
				<tr>
					<td class="tdr" width="10%">职位名称：</td>
					<td align="left"><input type="text" name="title" style="width:40%" data-rules="{required:true}" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"><input type="text" name="salary" style="width:40%" /></td>
				</tr>
				<tr>
					<td class="tdr" width="10%">邮箱：</td>
					<td align="left"><input type="email" name="email" style="width:40%"  data-rules="{required:true}"  /></td>
				</tr>
				<tr>
					<td class="tdr" width="10%">联系人：</td>
					<td align="left"><input type="text" name="contacter" style="width:40%"  data-rules="{required:true}"  /></td>
				</tr>
				<tr>
					<td class="tdr" width="10%">联系电话：</td>
					<td align="left"><input type="text" name="contacttel" style="width:40%"  data-rules="{required:true}"  /></td>
				</tr>
				<tr>
			  ...
			  <tr>
				...
				<td><textarea name="content" id="content" data-rules="{required:true}"></textarea></td>
			  </tr>
			 <tr>
			 	<td></td>
			    <td>
