...
<dl class="sub-l">
	...
	<dd><a href="<?php echo U('/articles_55');?>" <?php if($id == 55): ?>class="on"<?php endif; ?>>销售信息</a></dd>
		...
		<div class="c-r">
			<h2 class="sub-r">产品中心<em>您的当前位置 > 首页 > 产品中心</em></h2>
			<div class="c-r-c d-pd">
				<h3 class="dtitle"><?php echo ($getPro["name"]); ?></h3>
				<div class="editor">
					<div class="editor-c">
					<em>发布时间：<?php echo (date('Y-m-d',$getPro["time"])); ?></em><div class="sspan">分享到：</div><div class="share"><div class="bshare-custom"><div class="bsPromo bsPromo2"></div><a title="分享到QQ空间" class="bshare-qzone"></a><a title="分享到新浪微博" class="bshare-sinaminiblog"></a><a title="分享到人人网" class="bshare-renren"></a><a title="分享到腾讯微博" class="bshare-qqmb"></a><a title="分享到微信" class="bshare-weixin" href="javascript:void(0);"></a><a title="更多平台" class="bshare-more bshare-more-icon more-style-addthis"></a><span class="BSHARE_COUNT bshare-share-count" style="float: none;">33.7K</span></div><script type="text/javascript" charset="utf-8" src="http://static.bshare.cn/b/buttonLite.js#style=-1&amp;uuid=&amp;pophcol=3&amp;lang=zh"></script><script type="text/javascript" charset="utf-8" src="http://static.bshare.cn/b/bshareC0.js"></script></div>
					</div>
				</div>
				<div class="detail-c">
					<?php echo ($getPro["content"]); ?>
				...
				<div class="artilce-prenxt">
					<em class="pre-article fl">
						<?php if(empty($front)): ?><strong>上一篇：</strong>已经是第一条
				         <?php else: ?>
							<strong>上一篇：</strong><a href="<?php echo U(MODULE_NAME.'/Product/proDetail',array('id'=>$front['id']));?>" ><?php echo (msubstr($front["name"],0,26)); ?></a><?php endif; ?>
					</em>        
					<em class="nxt-article fr">        
				        <?php if(empty($after)): ?><strong>下一篇：</strong>已经是最后一条
				        <?php else: ?>
				        	<strong>下一篇：</strong><a href="<?php echo U(MODULE_NAME.'/Product/proDetail',array('id'=>$after['id']));?>" ><?php echo (msubstr($after["name"],0,26)); ?></a><?php endif; ?>
					</em>
				</div>
			</div>
			<div class="yy">
				...
				<!-- UY BEGIN -->
					...
					<script type="text/javascript" src="http://v2.uyan.cc/code/uyan.js?uid=1989213"></script>
					<!-- UY END -->
			</div>
		</div>
		<div class="clear"></div>
