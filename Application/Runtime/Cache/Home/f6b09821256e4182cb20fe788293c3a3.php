...
<div class="bnlazy sub-banner" data-original="/Public/images/6.jpg" width="100%" height="300" style="display: block; background-image: url(/Public/images/6.jpg);">  
</div>
	<div class="content">
		<div class="sub-left">
	...
	<ul class="sub-lul">
		...
		<div class="sub-right">
			<h2 class="sub-rtitle">寻猎流程</h2>
			<div class="sub-rc yahei" id="aboutus">
				<p>1.深入了解企业发展历程，企业文化，组织架构，职位需求等信息；</p>
				<p>2.分析职位需求，有的放矢，寻猎目标人才；</p>
				<p>3.推荐简历，并阐明推荐理由，一目了然；</p>
				<p>4.辅助企业面试安排；</p>
				<p>5.协助企业谈薪；</p>
				<p>6.出具录用通知书；</p>
				<p>7.入职后续的跟踪管理。帮助人才适应新平台，在平台上有更好发展。双向沟通，作协调工作，让企业用好人才，企业也能得到人才的才能效益。</p>
			</div>
		</div>
	</div>
<div class="footer">
